...
let categories = {
  ...
  function renderShop() {
    ...
    upgrades.forEach(upgrade => {
      ...
      // Affichage des images avec ou sans grisage
      const imgElements = document.querySelectorAll(`.img-village-bonus[data-item="${upgrade.name.toLowerCase()}"]`);
  ...
  function saveShop() {
    ...
    // Utilisation de localStorage pour la sauvegarde
  ...
  function loadShop() {
    ...
    if (save) {
      ...
      clickPower = loadedData.clickPower;
      autoClickPower = loadedData.autoClickPower;
      updateUI();
    }
  }